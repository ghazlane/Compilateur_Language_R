...
//--------------------------------------------------------------
typedef enum {
	ID_TOKEN, IF_TOKEN, WHILE_TOKEN, REPEAT_TOKEN, BREAK_TOKEN, NEXT_TOKEN, FOR_TOKEN, IN_TOKEN, PV_TOKEN, PT_TOKEN, PLUS_TOKEN ,
    ...
    PF_TOKEN, ACCO_TOKEN, ACCF_TOKEN, CRO_TOKEN, CRF_TOKEN, APS_TOKEN, NUM_TOKEN, ERREUR_TOKEN, COM_TOKEN, DPT_TOKEN
} CODE_LEX ;

typedef  struct { CODE_LEX CODE; char NOM[20]; } TSym_Cour;
TSym_Cour	SYM_COUR;

static char MOTS_CLES[9][10]={ "if", "while", "repeat", "break", "next", "for", "in"};


static char Code_Lex_Chaine[50][50] ={
	"ID_TOKEN", "IF_TOKEN", "WHILE_TOKEN", "REPEAT_TOKEN", "BREAK_TOKEN", "NEXT_TOKEN", "FOR_TOKEN", "IN_TOKEN", "PV_TOKEN", "PT_TOKEN",
    ...
    "NUM_TOKEN", "ERREUR_TOKEN", "COM_TOKEN", "DPT_TOKEN"
};

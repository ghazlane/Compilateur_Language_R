...
//--------------------------------------------------------------
typedef enum {
	ID_TOKEN, IF_TOKEN, ELSE_TOKEN, WHILE_TOKEN, REPEAT_TOKEN, BREAK_TOKEN, NEXT_TOKEN, FOR_TOKEN, IN_TOKEN, FUNCTION_TOKEN, RETURN_TOKEN, PV_TOKEN, PT_TOKEN, PLUS_TOKEN ,
...
static char MOTS_CLES[11][10]={ "if", "else", "while", "repeat", "break", "next", "for", "in", "function", "return"};


static char Code_Lex_Chaine[50][50] ={
	"ID_TOKEN", "IF_TOKEN", "ELSE_TOKEN", "WHILE_TOKEN", "REPEAT_TOKEN", "BREAK_TOKEN", "NEXT_TOKEN", "FOR_TOKEN", "IN_TOKEN", "FUNCTION_TOKEN", "RETURN_TOKEN", "PV_TOKEN", "PT_TOKEN",
